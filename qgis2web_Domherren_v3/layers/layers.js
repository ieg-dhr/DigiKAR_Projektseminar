...
jsonSource_MarquardSchenkvonCastell_1.addFeatures(features_MarquardSchenkvonCastell_1);cluster_MarquardSchenkvonCastell_1 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_MarquardSchenkvonCastell_1
});
var lyr_MarquardSchenkvonCastell_1 = new ol.layer.Vector({
                declutter: true,
                source:cluster_MarquardSchenkvonCastell_1, 
...
jsonSource_LotharFriedrichvonMetternichBurscheid_2.addFeatures(features_LotharFriedrichvonMetternichBurscheid_2);cluster_LotharFriedrichvonMetternichBurscheid_2 = new ol.source.Cluster({
  distance: 10,
...
var lyr_LotharFriedrichvonMetternichBurscheid_2 = new ol.layer.Vector({
                declutter: true,
                source:cluster_LotharFriedrichvonMetternichBurscheid_2, 
...
jsonSource_KarlEmmerichFranzvonBreidbachBrresheim_3.addFeatures(features_KarlEmmerichFranzvonBreidbachBrresheim_3);cluster_KarlEmmerichFranzvonBreidbachBrresheim_3 = new ol.source.Cluster({
  distance: 10,
...
var lyr_KarlEmmerichFranzvonBreidbachBrresheim_3 = new ol.layer.Vector({
                declutter: true,
                source:cluster_KarlEmmerichFranzvonBreidbachBrresheim_3, 
...
jsonSource_JohannWilhelmWolffMetternichzurGracht_4.addFeatures(features_JohannWilhelmWolffMetternichzurGracht_4);cluster_JohannWilhelmWolffMetternichzurGracht_4 = new ol.source.Cluster({
  distance: 10,
...
var lyr_JohannWilhelmWolffMetternichzurGracht_4 = new ol.layer.Vector({
                declutter: true,
                source:cluster_JohannWilhelmWolffMetternichzurGracht_4, 
...
jsonSource_JohannPhilippFranzGrafvonSchnborn_5.addFeatures(features_JohannPhilippFranzGrafvonSchnborn_5);cluster_JohannPhilippFranzGrafvonSchnborn_5 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_JohannPhilippFranzGrafvonSchnborn_5
});
var lyr_JohannPhilippFranzGrafvonSchnborn_5 = new ol.layer.Vector({
                declutter: true,
                source:cluster_JohannPhilippFranzGrafvonSchnborn_5, 
...
jsonSource_JohannHeppenheimgenanntvonSaal_6.addFeatures(features_JohannHeppenheimgenanntvonSaal_6);cluster_JohannHeppenheimgenanntvonSaal_6 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_JohannHeppenheimgenanntvonSaal_6
});
var lyr_JohannHeppenheimgenanntvonSaal_6 = new ol.layer.Vector({
                declutter: true,
                source:cluster_JohannHeppenheimgenanntvonSaal_6, 
...
jsonSource_HugoWolfgangvonKesselstatt_7.addFeatures(features_HugoWolfgangvonKesselstatt_7);cluster_HugoWolfgangvonKesselstatt_7 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_HugoWolfgangvonKesselstatt_7
});
var lyr_HugoWolfgangvonKesselstatt_7 = new ol.layer.Vector({
                declutter: true,
                source:cluster_HugoWolfgangvonKesselstatt_7, 
...
jsonSource_HugoFranzKarlvonEltzKempenich_8.addFeatures(features_HugoFranzKarlvonEltzKempenich_8);cluster_HugoFranzKarlvonEltzKempenich_8 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_HugoFranzKarlvonEltzKempenich_8
});
var lyr_HugoFranzKarlvonEltzKempenich_8 = new ol.layer.Vector({
                declutter: true,
                source:cluster_HugoFranzKarlvonEltzKempenich_8, 
...
jsonSource_HeinrichWilhelmHarffvonDreyborn_9.addFeatures(features_HeinrichWilhelmHarffvonDreyborn_9);cluster_HeinrichWilhelmHarffvonDreyborn_9 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_HeinrichWilhelmHarffvonDreyborn_9
});
var lyr_HeinrichWilhelmHarffvonDreyborn_9 = new ol.layer.Vector({
                declutter: true,
                source:cluster_HeinrichWilhelmHarffvonDreyborn_9, 
...
jsonSource_HeinrichFerdinandvonderLeyen_10.addFeatures(features_HeinrichFerdinandvonderLeyen_10);cluster_HeinrichFerdinandvonderLeyen_10 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_HeinrichFerdinandvonderLeyen_10
});
var lyr_HeinrichFerdinandvonderLeyen_10 = new ol.layer.Vector({
                declutter: true,
                source:cluster_HeinrichFerdinandvonderLeyen_10, 
...
jsonSource_DietrichKasparvonFrstenberg_11.addFeatures(features_DietrichKasparvonFrstenberg_11);cluster_DietrichKasparvonFrstenberg_11 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_DietrichKasparvonFrstenberg_11
});
var lyr_DietrichKasparvonFrstenberg_11 = new ol.layer.Vector({
                declutter: true,
                source:cluster_DietrichKasparvonFrstenberg_11, 
...
jsonSource_DamianFriedrichvonderLeyenHohengeroldseck_12.addFeatures(features_DamianFriedrichvonderLeyenHohengeroldseck_12);cluster_DamianFriedrichvonderLeyenHohengeroldseck_12 = new ol.source.Cluster({
  distance: 10,
...
var lyr_DamianFriedrichvonderLeyenHohengeroldseck_12 = new ol.layer.Vector({
                declutter: true,
                source:cluster_DamianFriedrichvonderLeyenHohengeroldseck_12, 
...
jsonSource_ChristophRudolfvonStadion_13.addFeatures(features_ChristophRudolfvonStadion_13);cluster_ChristophRudolfvonStadion_13 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_ChristophRudolfvonStadion_13
});
var lyr_ChristophRudolfvonStadion_13 = new ol.layer.Vector({
                declutter: true,
                source:cluster_ChristophRudolfvonStadion_13, 
...
lyr_HeinrichWilhelmHarffvonDreyborn_9.set('fieldImages', {'FIELD1': 'Range', 'pers_name': 'TextEdit', 'event_after-date': 'TextEdit', 'event_before-date': 'TextEdit', 'event_start': 'TextEdit', 'event_end': 'TextEdit', 'display_date': 'Range', 'event_type': 'TextEdit', 'pers_function': 'TextEdit', 'inst_name': 'TextEdit', 'place_name': 'TextEdit', 'place_count': 'Range', 'country': 'TextEdit', '# Full Address': 'TextEdit', 'comment': 'TextEdit', 'source': 'TextEdit', });
lyr_HeinrichFerdinandvonderLeyen_10.set('fieldImages', {'FIELD1': 'Range', 'pers_name': 'TextEdit', 'event_after-date': 'TextEdit', 'event_before-date': 'TextEdit', 'event_start': 'TextEdit', 'event_end': 'TextEdit', 'display_date': 'Range', 'event_type': 'TextEdit', 'pers_function': 'TextEdit', 'inst_name': 'TextEdit', 'place_name': 'TextEdit', 'place_count': 'Range', 'country': 'TextEdit', '# Full Address': 'TextEdit', 'comment': 'TextEdit', 'source': 'TextEdit', });
lyr_DietrichKasparvonFrstenberg_11.set('fieldImages', {'FIELD1': 'Range', 'pers_name': 'TextEdit', 'event_after-date': 'TextEdit', 'event_before-date': 'TextEdit', 'event_start': 'TextEdit', 'event_end': 'TextEdit', 'display_date': 'TextEdit', 'event_type': 'TextEdit', 'pers_function': 'TextEdit', 'inst_name': 'TextEdit', 'place_name': 'TextEdit', 'place_count': 'Range', 'country': 'TextEdit', '# Full Address': 'TextEdit', 'comment': 'TextEdit', 'source': 'TextEdit', });
lyr_DamianFriedrichvonderLeyenHohengeroldseck_12.set('fieldImages', {'FIELD1': 'Range', 'pers_name': 'TextEdit', 'event_after-date': 'TextEdit', 'event_before-date': 'TextEdit', 'event_start': 'TextEdit', 'event_end': 'TextEdit', 'display_date': 'TextEdit', 'event_type': 'TextEdit', 'pers_function': 'TextEdit', 'inst_name': 'TextEdit', 'place_name': 'TextEdit', 'place_count': 'Range', 'country': 'TextEdit', '# Full Address': 'TextEdit', 'comment': 'TextEdit', 'source': 'TextEdit', });
lyr_ChristophRudolfvonStadion_13.set('fieldImages', {'FIELD1': 'Range', 'pers_name': 'TextEdit', 'event_after-date': 'TextEdit', 'event_before-date': 'TextEdit', 'event_start': 'TextEdit', 'event_end': 'TextEdit', 'display_date': 'TextEdit', 'event_type': 'TextEdit', 'pers_function': 'TextEdit', 'inst_name': 'TextEdit', 'place_name': 'TextEdit', 'place_count': 'Range', 'country': 'TextEdit', '# Full Address': 'TextEdit', 'comment': 'TextEdit', 'source': 'TextEdit', });
lyr_AdolphHundvonSaulheim_14.set('fieldImages', {'FIELD1': 'Range', 'pers_name': 'TextEdit', 'event_after-date': 'TextEdit', 'event_before-date': 'TextEdit', 'event_start': 'TextEdit', 'event_end': 'TextEdit', 'display_date': 'TextEdit', 'event_type': 'TextEdit', 'pers_function': 'TextEdit', 'inst_name': 'TextEdit', 'place_name': 'TextEdit', 'place_count': 'Range', 'country': 'TextEdit', '# Full Address': 'TextEdit', 'comment': 'TextEdit', 'source': 'TextEdit', });
