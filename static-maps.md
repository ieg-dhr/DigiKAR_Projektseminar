...
<a href="./maps/Cluster_points.png"><img src="./maps/Domherren_places-frequency.png" width="300px" align="left"/></a>
<p>The map on the left shows all places in the collected dataset as coloured clusters. The largest dots, displayed in purple, indicate place names that are disproportionately frequent in the data.</p>
