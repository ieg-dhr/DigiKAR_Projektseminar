...
<p align="justify">Please view or download the <a href="./CSV%20tables/FactoidList_30Juni2022_enriched.csv">updated data table in CSV format</a> or check the data with coordinates in <a href="./GeoJSON%20layers/Domherren_v3.geojson">GeoJSON format (v2)</a>.</p>
